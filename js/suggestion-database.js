const suggestionDatabase = {
  face_dark: [
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Find the light source (window, lamp)', 'Turn your body toward the light', 'Face the light directly']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Identify the nearest light source', 'Move toward the light', 'Keep facing the light']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Find white paper or object', 'Place below your face', 'Adjust angle to reflect light']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Turn on another phone\'s flashlight', 'Shine from 45° angle', 'Adjust distance for brightness']
          }
        },
        intensity: 0.6
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Place lamp in front of face', 'Angle light slightly downward', 'Adjust brightness to avoid overexposure']
          }
        },
        intensity: 0.7
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Place ring light behind camera', 'Adjust height to face level', 'Set brightness to 60-80%']
          }
        },
        intensity: 0.8
      },
    ...
    },
    {
      ...
      params: {
        position: {
          description: { zh: '主灯45度侧光，辅灯对侧填充', en: 'Key light at 45°, fill light on opposite side' },
          angle: 45,
        ...
        action: {
          ...
          steps: {
            zh: ['主灯放在侧面45度角，距离1-1.5米', '辅灯放在对侧，距离1.5-2米', '主灯亮度100%，辅灯亮度50-70%'],
            en: ['Key light at 45° angle, 1-1.5m away', 'Fill light on opposite side, 1.5-2m away', 'Key at 100%, fill at 50-70%']
          }
        },
        intensity: 0.9
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Identify bright and dark sides', 'Turn body 15-30° toward bright side', 'Keep face toward camera']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Find white object or reflector', 'Place next to shadow side of face', 'Adjust angle to reflect light']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Turn on phone flashlight', 'Shine from 45° on shadow side', 'Adjust distance for brightness']
          }
        },
        intensity: 0.5
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Place lamp on shadow side', 'Aim light at shadow area', 'Set to medium brightness']
          }
        },
        intensity: 0.6
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Place fill light on shadow side', 'Aim at shadow area', 'Set to 50-70% of key light']
          }
        },
        intensity: 0.6
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Find tree shade, building shadow, or indoors', 'Ensure no direct overhead light', 'Keep ambient light even']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Lift chin slightly', 'Keep face toward light source', 'Avoid over-tilting for natural look']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Wear wide-brim hat or use umbrella', 'Ensure shadow covers entire face', 'Adjust angle to avoid covering eyes']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Place reflector below face', 'Adjust angle to reflect light into shadows', 'Control intensity to avoid over-brightening']
          }
        },
        intensity: 0.5
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Attach softbox or diffuser to overhead light', 'Adjust distance from face', 'Ensure even, soft light']
          }
        },
        intensity: 0.7
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Find a brighter environment', 'Move closer to windows or lights', 'Ensure sufficient light on face']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Turn on all lights in the room', 'Ensure light from multiple directions', 'Avoid single light source shadows']
          }
        },
        intensity: null
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Set phone screen to max brightness', 'Open white background image or webpage', 'Face screen toward your face']
          }
        },
        intensity: 0.4
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Turn on phone flashlight or desk lamp', 'Shine from front or side onto face', 'Adjust distance for brightness']
          }
        },
        intensity: 0.6
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Set up LED fill light', 'Adjust brightness and color temperature', 'Ensure even light on face']
          }
        },
        intensity: 0.8
      },
      ...
      params: {
        ...
        action: {
          ...
          steps: {
            ...
            en: ['Set up main light (ring light or softbox)', 'Add fill light for shadows', 'Adjust brightness ratio of each light']
          }
        },
        intensity: 0.9
      },
